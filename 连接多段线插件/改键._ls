...
(defun c:tt()
 ...
 ;切断相交线
 (vla-SendCommand doc(strcat"_overkill "(rtos(car p1)2 2)","(rtos(cadr p1)2 2)" "(rtos(car p2)2 2)","(rtos(cadr p2)2 2)" " " "));;切断相交线overkill
 ;线变复线TLINETOPOLY
 (command)
...
(defun modent (el tylst / c)  ;(modent el '((8 . "1") (62 . 1)))
